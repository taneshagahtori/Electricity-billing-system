...
public class GenerateBill extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent ae){
          try{
              ...
              area.setText("\t Reliance Power Limited\n ELETRICITY BILL GENERATED FOR THE MONTH\n\t OF "+month+", 2024\n\n\n");
              
              ResultSet rs=c.s.executeQuery("select * from customer where meter_no= '"+meter+"'");
              if(rs.next()){
                  area.append("\n    Customer Name:" + rs.getString("name")); //appends the text 
              ...
              if(rs.next()){
                  area.append("\n    Customer Location:" + rs.getString("meter_location")); //appends the text 
              ...
              if(rs.next()){
                  area.append("\n");
                  area.append("\n    Cost Per Unit:" + rs.getString("cost_per_unit")); //appends the text 
              ...
              if(rs.next()){
                  area.append("\n");
                  area.append("\n    Current Month:" + rs.getString("month")); //appends the text 
